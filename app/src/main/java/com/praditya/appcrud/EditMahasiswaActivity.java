...
public class EditMahasiswaActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(EditMahasiswaActivity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CHOOSE_IMAGE && resultCode == RESULT_OK) {
            ...
            Glide.with(this).load(BitmapFactory.decodeFile(getRealPathFromURI(selectedImage))).into(imgMahasiswa);
        }

        if(requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK){
            File capturedImage = new File(currentPhotoPath);
            Glide.with(this).load(capturedImage).into(imgMahasiswa);
        }
    }
    ...
    private void setData(Mahasiswa mahasiswa) {
        ...
        edtName.setText(mahasiswa.getNama());
        edtAddress.setText(mahasiswa.getAlamat());
        Glide.with(EditMahasiswaActivity.this)
    ...
    private void updateMahasiswa(Mahasiswa mahasiswa) {
        ...
        if (currentPhotoPath != null) {
            ...
            Call<ActionResponse> updateMahasiswaResponseCall = RetrofitClient.getInstance().getAPI().updateMahasiswaWithPhoto(requestNrp, requestName, requestAlamat, photo);
            updateMahasiswaResponseCall.enqueue(new Callback<ActionResponse>() {
                @Override
            ...
            Call<ActionResponse> updateMahasiswaResponseCall = RetrofitClient.getInstance().getAPI().updateMahasiswa(mahasiswa.getNrp(), mahasiswa.getNama(), mahasiswa.getAlamat());
            updateMahasiswaResponseCall.enqueue(new Callback<ActionResponse>() {
                @Override
                public void onResponse(Call<ActionResponse> call, Response<ActionResponse> response) {
                    showLoading(false);
